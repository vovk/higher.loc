...
function optionsframework_options() {
 ...
 'desc' => '<h2 style="color: #FFF !important;">' . esc_attr__( 'Upgrade to Premium Theme & Enable Full Features!', 'esell' ) . '</h2>
            ...
            <p><span class="buypre"><a href="' . esc_url(__('http://www.insertcart.com/product/esell-business-wp-theme/','esell')) . '" target="_blank">' . esc_attr__( 'Upgrade Now', 'esell' ) . '</a></span><span class="buypred"><a href="' . esc_url(__('http://www.insertcart.com/esell-wordpress-theme-documentation/','esell')) . '" target="_blank">' . esc_attr__( 'How to Setup Theme !', 'esell' ) . '</a></span></p>',
            'class' => 'tesingh',
            'type' => 'info');
	...
	$options[] = array(
		...
		'type' => 'checkbox');
	$options[] = array(
		'name' => __('Website Width in Pixels [It Calculate Max Width]', 'esell'),
		'desc' => __('PX-  Please input Max-width for your website Default value 1080px, also it is 5% padding from sides', 'esell'),
		'id' => 'esell_maxwidth',
		'std' => '1080',
		'class' => 'mini',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Bottom Box 1 Configure ', 'esell'),
		'desc' => __('Column Heading', 'esell'),
		'id' => 'esell_columnh1',
		...
		'textarea_rows' => 5));
	$options[] = array(
		'name' => __('Bottom Box 2 Configure ', 'esell'),
		'desc' => __('Column Heading', 'esell'),
		'id' => 'esell_columnh3',
		'std' => 'Column title here',
		'type' => 'text');
		...
		'textarea_rows' => 5));
	$options[] = array(
		'name' => __('Bottom Box 3 Configure ', 'esell'),
		'desc' => __('Column Heading', 'esell'),
		'id' => 'esell_columnh5',
		'std' => 'Column Title here',
		'type' => 'text');
		...
		'textarea_rows' => 5));
	$options[] = array(
		'name' => __('WooCommerce', 'esell'),
		'type' => 'heading');	
	$options[] = array(
		'name' => __('Show or Hide WooCommerce products from Front page[Pro only]', 'esell'),
		'id' => 'esell_frontwooproducts',
		'std' => 'on',
		'type' => 'radio',
		'options' => array(
						'on' => 'Show',
	...
	$options[] = array(
		'name' => __('Enable Quick Checkout Button', 'esell'),
		'desc' => __('Quick checkout button will be added into product page after add to cart button, that redirect users directly to checkout page', 'esell'),
		'id' => 'esell_quickcheckout',
		'std' => 'on',
		'type' => 'radio',
		'options' => array(
						'on' => __('Enable','esell'),
						'off' => __('Disable','esell')
							));	
	$options[] = array(
		'desc' => __('Custom name of Quick Checkout button', 'esell'),
		'id' => 'esell_quickcheckoutname',
		'std' => __('Quick Checkout','esell'),
		'class' => 'mini',
		'type' => 'text');			
		
	$options[] = array(
		'name' => __('Image Flip for Product', 'esell'),
		'desc' => __('Allow Image flip on product page if second image is available ', 'esell'),
		'id' => 'esell_imageflip',
		'std' => 'on',
		'type' => 'radio',
		'options' => array(
		...
		$options[] = array(		
		'name' => __('Detail Button on product page customize', 'esell'),
		'desc' => __('Detail button on product hide or show', 'esell'),
		'id' => 'esell_woodetailbut',
		'std' => 'on',
		'type' => 'radio',
		'options' => array(
						'on' => __('Show','esell'),
		...
		$options[] = array(
		'name' => __('Sale Button Text', 'esell'),
		'id' => 'esell_woosalebuttontext',
		'std' => 'Sale!',
		'class' => 'mini',
		'type' => 'text');		
		
		$options[] = array(
		'desc' => __('<span class="pre-titlehome">Color Customize (Pro users Only)</span>','esell'), 
		'type' => 'info');
		$options[] = array(
		'name' => __('Numbers of Featured Woocommerce Products', 'esell'),
		'desc' => __('Select how many product (Featured products)you want to display on front page Default: 8', 'esell'),
